...
<nav class="level">
	<div class="level-item has-text-centered">
		<div>
			...
			<p class="title" name="DATE_CREATION"><?= htmlspecialchars($arResult['task']['DATE_CREATION']->format('d.m.Y'))?></p>
		</div>
	</div>
	<div class="level-item has-text-centered">
		<div>
			<p class="heading">Priority</p>
			<p class="select is-link" name="PRIORITY"><?= htmlspecialchars($arResult['task']['PRIORITY_SELECT'])?></p>
		</div>
	</div>
	<div class="level-item has-text-centered">
		<div>
			<p class="heading">Status</p>
			<p class="select is-link" name="STATUS"><?= htmlspecialchars($arResult['task']['STATUS_SELECT'])?></p>
		</div>
	</div>
	<div class="level-item has-text-centered">
		<div class="control">
