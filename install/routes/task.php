...
return function (RoutingConfigurator $routes) {
	...
	$routes->get('/issues/{id}/edit/', new PublicPageController('/local/modules/up.task/views/task-create.php'));
	$routes->get('/issues/{id}/', new PublicPageController('/local/modules/up.task/views/task-details.php'));
